...
export const search = async (query,sort_by_date=0,type='podcast',offset=0,len_min=10,len_max=100,genre_ids=[68,82],published_before=Date.now(),published_after=0,only_in=['title','description'],language='English',safe_mode=1)=>{
