	...
	describe('Create should', () => {
		describe('fail to create user ', () => {
			mochaEach([
				[{}],
				[{
					email: 'four@gmail.com', first_name: 'fo',
					last_name: 'ur', social_login_type: 'auth', auth0_id: 'auth0|44444444444'
				}],
				[{
					username: 'user_4', first_name: 'fo',
					last_name: 'ur', social_login_type: 'auth', auth0_id: 'auth0|44444444444'
				}],
				[{
					username: 'user_4', email: 'four@gmail.com',
					last_name: 'ur', social_login_type: 'auth', auth0_id: 'auth0|44444444444'
				}],
				[{
					username: 'user_4', email: 'four@gmail.com', first_name: 'fo',
					social_login_type: 'auth', auth0_id: 'auth0|44444444444'
				}],
				[{
					username: 'user_4', email: 'four@gmail.com', first_name: 'fo',
					last_name: 'ur', auth0_id: 'auth0|44444444444'
				}],
				[{
					username: 'user_4', email: 'four@gmail.com', first_name: 'fo',
					last_name: 'ur', social_login_type: 'auth',
				}],
			])
				.it('with Missing Parameters: %j', (newUser) => {
